...
class Solar(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r, cost_s, cost_opm, n, T_noct, G_noct, G_max, fpv, kt): 
...
class Eolic(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r, cost_s, cost_opm, s_in, s_rate, s_out, rp, n, n_eq, h):
        self.cost_opm = cost_opm #Operation & Maintenance cost 
...
class Diesel(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r, cost_s, G_min, G_max, n, f0, f1):
