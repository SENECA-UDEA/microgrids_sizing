...
class Generator():
    ...
    def __init__(self, id_gen, tec, alt, va_op, area, cost_up, cost_r, cost_om, cost_s, c_min, c_max):
        self.id_gen = id_gen
        self.tec = tec
        self.alt = alt
        self.va_op = va_op
...
class Solar(Generator):
    ...
    def __init__(self, id_gen, tec, alt, va_op, area, cost_up, cost_r, cost_om, cost_s,  c_min, c_max, ef, G_test, R_test):
        self.ef = ef
        self.G_test = G_test
        self.R_test = R_test
