...
class Solar(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r, cost_s,
                 cost_fopm, cost_vopm, n, T_noct, G_noct, Ppv_stc, fpv, kt): 
...
class Eolic(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r, cost_s,
                 cost_fopm, cost_vopm, s_in, s_rate, s_out, P_y, n_eq, h):
    ...
    def eolic_generation(self, forecastWt, h2, coef_hel, deg):
        ...
        for t in list(forecastWt.index.values):
            ...
            if i <= self.s_in:
              ...
              self.gen_rule[t] = self.P_y * ((i**self.n_eq - self.s_in**self.n_eq) / (self.s_rate
                                                                                      **self.n_eq - self.s_in**self.n_eq))
...
class Diesel(Generator):
    def __init__(self, id_gen, tec, br, area, cost_up, cost_r,
                 cost_s, cost_fopm, DG_min, DG_max, f0, f1):
        ...
        super(Diesel, self).__init__(id_gen, tec, br, area, 
                                     cost_up, cost_r, cost_s, cost_fopm)


class Battery():
    def __init__(self, id_bat, tec, br, efc, efd, eb_zero, soc_max, dod_max,
                 alpha, area, cost_up, cost_fopm, cost_r, cost_s, cost_vopm):
