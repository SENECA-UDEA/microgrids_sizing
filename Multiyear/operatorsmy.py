...
class Sol_constructor():
    ...
    def initial_solution (self, 
        ...
        #create a false Diesel auxiliar
            ...
            if (strategy_def == "diesel"):
                lcoe_cost, df_results, state, time_f = d(sol_try, self.demand_df, instance_data, cost_data, rand_ob, my_data)
            else:
                state = 'no feasible'
...
class Search_operator():
    ...
    def removeobject(self, sol_actual, delta): #remove one generator or battery
    ...
    def addobject(self, sol_actual, available_bat, available_gen, list_tec_gen, remove_report, fuel_cost, rand_ob, delta): #add generator or battery
        solution = copy.deepcopy(sol_actual)
                ...
                if dic.tec == rand_tec:
                    ...
                    if gen_generator > gen_reference:
                        if dic.tec == 'D':
                            ...
                            lcoe_inf = (dic.cost_up + dic.cost_r - dic.cost_s) 
                        else:
                            ...
                            lcoe_inf = (dic.cost_up * delta + dic.cost_r - dic.cost_s) 
