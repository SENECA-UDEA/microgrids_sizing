...
for iii in range(1, 865):
    ...
    aux_instance_data['sminus_cost'] = sminus_cost_run * aux_instance_data['sminus_cost']
    aux_instance_data['splus_cost'] = sminus_cost_run * aux_instance_data['splus_cost']
    ...
    sol_feasible, tnpccrf_calc_best = sol_constructor.initial_solution(aux_instance_data,
                                                   generators_dict,
                                                   batteries_dict,
                                                   technologies_dict,
                                                   renewables_dict,
